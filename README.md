...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5fc4f421a8863c001d2f5524
...
To start editing your site, you can use the Sanity interface at https://fierce-comet-4f421.sanity.studio/.
...
Generated at `2020-11-30T13:31:40.335Z` by Stackbit version `0.3.38`.